      ...
      <ImageBackground
        ...
        <View style={{flex: 1, alignItems: 'center'}}>
          <TouchableOpacity onPress={() => this.goToLogin()}>
            <View
              style={{
                backgroundColor: '#baccED',
                width: 65,
                height: 65,
                borderRadius: 50,
              }}>
              <Image
                source={require('../image/icon_login.png')}
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              {isLogin ? (
                <Image
                  ...
                  style={{width: 15, height: 15, marginLeft: 10, marginTop: 13}}
                />
              ) : null}
            </View>
          </TouchableOpacity>
        ...
        <View style={{flex: 3, backgroundColor: '#fff', borderRadius: 20}}>
          <View
            ...
            <TouchableOpacity
              ...
              onPress={() => this.goToEmptyPage()}>
              <Image
                source={require('../image/icon_choujiang.png')}
                style={styles.img}
              />
            ...
            <TouchableOpacity
              ...
              onPress={() => this.goToEmptyPage()}>
              <Image
                source={require('../image/icon_life.png')}
                style={styles.img}
              />
            ...
            <TouchableOpacity
              ...
              onPress={() => this.goToEmptyPage()}>
              <Image
                source={require('../image/icon_VIP.png')}
                style={styles.img}
              />
