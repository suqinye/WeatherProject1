        ...
        return(
            ...
            <ImageBackground source={require('../image/icon_weatherImgBG.jpg')} style={{flex:1,height:height,width:width}}>
                <View style={{height:height}}>
                    ...
                    <View style={{height:height-40,marginTop:10,backgroundColor:'#ccc'}}>
                        <View  style={{backgroundColor: '#f5f5f5', flexDirection:'row',justifyContent:'space-between',height:60,alignItems:'center',borderBottomWidth:0.5,borderColor:'#657089'}}>
                            ...
                            <View style={{flexDirection:'row',alignItems:'center',backgroundColor:'#baccED',width:45,height:45,borderRadius:50,marginRight:37}}>
                        ...
                        <View style={{backgroundColor: '#f5f5f5', height: 60, justifyContent: 'center', paddingLeft: 15, paddingRight: 15}}>
                            <TouchableOpacity onPress={() => {this.goToSignOut()}}>
                                <View style={{backgroundColor: '#39B6FB', height: 35, alignItems: 'center', justifyContent: 'center', borderRadius: 3}}>
